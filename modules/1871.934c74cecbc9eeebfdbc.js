"use strict";
(self.webpackChunkfederation_modules = self.webpackChunkfederation_modules || []).push([[1871], {
    1871: (e, t, n) => {
        function r(e, t) {
            return function() {
        ...
        const T = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : global
          , v = e => !f(e) && e !== T
          , C = (N = "undefined" != typeof Uint8Array && s(Uint8Array),
        e => N && e instanceof N);
        var N;
        ...
        k.from = (e, t, n, r, o, s) => {
            ...
            return L.toFlatObject(e, i, (function(e) {
        ...
        var W = function(e, t, n) {
            ...
            const r = (n = L.toFlatObject(n, {
              ...
              , s = n.dots
              , i = n.indexes
              , a = (n.Blob || "undefined" != typeof Blob && Blob) && L.isSpecCompliantForm(t);
            if (!L.isFunction(o))
            ...
            function c(e) {
                ...
                return L.isArrayBuffer(e) || L.isTypedArray(e) ? a && "function" == typeof Blob ? new Blob([e]) : Buffer.from(e) : e
            }
            function u(e, n, o) {
                let a = e;
                if (e && !o && "object" == typeof e)
                    if (L.endsWith(n, "{}"))
                        n = r ? n : n.slice(0, -2),
                        e = JSON.stringify(e);
                    else if (L.isArray(e) && function(e) {
                        return L.isArray(e) && !e.some(M)
                    }(e) || (L.isFileList(e) || L.endsWith(n, "[]")) && (a = L.toArray(e)))
                        return n = H(n),
                        ...
                        !1;
                return !!M(e) || (t.append(J(o, n, s), c(e)),
                !1)
            }
            const l = []
              , f = Object.assign(V, {
        ...
        function Z(e, t, n) {
            ...
            const r = n && n.encode || Q
              , o = n && n.serialize;
            let s;
            if (s = o ? o(t, n) : L.isURLSearchParams(t) ? t.toString() : new X(t,n).toString(r),
            s) {
                const t = e.indexOf("#");
                -1 !== t && (e = e.slice(0, t)),
                e += (-1 === e.indexOf("?") ? "?" : "&") + s
          ...
          , ne = function(e) {
            function t(e, n, r, o) {
                ...
                const i = Number.isFinite(+s)
                  , a = o >= e.length;
                return s = !s && L.isArray(r) ? r.length : s,
                a ? (L.hasOwnProp(r, s) ? r[s] = [r[s], n] : r[s] = n,
                !i) : (r[s] && L.isObject(r[s]) || (r[s] = []),
                t(e, n, r[s], o) && L.isArray(r[s]) && (r[s] = function(e) {
                    const t = {}
                      , n = Object.keys(e);
                    let r;
                    const o = n.length;
          ...
          , oe = {
            ...
            transformRequest: [function(e, t) {
                const n = t.getContentType() || ""
                  ...
                  , o = L.isObject(e);
                if (o && L.isHTMLForm(e) && (e = new FormData(e)),
                L.isFormData(e))
                        ...
                        return function(e, t) {
                            return W(e, new te.classes.URLSearchParams, Object.assign({
                                visitor: function(e, t, n, r) {
                                    return te.isNode && L.isBuffer(e) ? (this.append(t, e.toString("base64")),
        ...
        var se = oe;
        const ie = L.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"])
          , ae = Symbol("internals");
        function ce(e) {
        ...
        function le(e, t, n, r, o) {
            return L.isFunction(r) ? r.call(this, t, n) : (o && (t = n),
            L.isString(t) ? L.isString(r) ? -1 !== t.indexOf(r) : L.isRegExp(r) ? r.test(t) : void 0 : void 0)
        }
        class fe {
            constructor(e) {
                e && this.set(e)
            ...
            set(e, t, n) {
                ...
                return L.isPlainObject(e) || e instanceof this.constructor ? s(e, t) : L.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim()) ? s((e => {
                    const t = {};
                    let n, r, o;
                    return e && e.split("\n").forEach((function(e) {
                        o = e.indexOf(":"),
            ...
            delete(e, t) {
                ...
                return L.isArray(e) ? e.forEach(o) : o(e),
                r
            }
            clear(e) {
            ...
            static accessor(e) {
                ...
                return L.isArray(e) ? e.forEach(r) : r(e),
                this
            }
        }
        ...
        const Oe = {
            ...
            xhr: "undefined" != typeof XMLHttpRequest && function(e) {
                return new Promise((function(t, n) {
                    ...
                    L.isFormData(r) && (te.isStandardBrowserEnv || te.isStandardBrowserWebWorkerEnv ? o.setContentType(!1) : o.setContentType("multipart/form-data;", !1));
                    ...
                    if (c.open(e.method.toUpperCase(), Z(u, e.params, e.paramsSerializer), !0),
                    c.timeout = e.timeout,
                    ...
                    ,
                    c.onabort = function() {
                        c && (n(new z("Request aborted",z.ECONNABORTED,e,c)),
                        c = null)
                    }
                    ,
                    c.onerror = function() {
                        n(new z("Network Error",z.ERR_NETWORK,e,c)),
                        c = null
                    }
                    ,
                    c.ontimeout = function() {
                        ...
                        n(new z(t,r.clarifyTimeoutError ? z.ETIMEDOUT : z.ECONNABORTED,e,c)),
                        c = null
                    }
                    ,
                    te.isStandardBrowserEnv) {
                        const t = (e.withCredentials || Ee(u)) && e.xsrfCookieName && ge.read(e.xsrfCookieName);
                        t && o.set(e.xsrfHeaderName, t)
                    }
                    void 0 === r && o.setContentType(null),
                    "setRequestHeader"in c && L.forEach(o.toJSON(), (function(e, t) {
                    ...
                    f && -1 === te.protocols.indexOf(f) ? n(new z("Unsupported protocol " + f + ":",z.ERR_BAD_REQUEST,e)) : c.send(r || null)
                }
                ))
            }
        };
        ...
        function Re(e) {
            ...
            (e => {
                ...
                !(r = L.isString(n) ? Oe[n.toLowerCase()] : n)); o++)
                    ;
                if (!r) {
                    if (!1 === r)
                        throw new z(`Adapter ${n} is not supported by the environment`,"ERR_NOT_SUPPORT");
                    throw new Error(L.hasOwnProp(Oe, n) ? `Adapter '${n}' is not available in the build` : `Unknown adapter '${n}'`)
                }
                if (!L.isFunction(r))
                    throw new TypeError("adapter is not a function");
                return r
            }
            )(e.adapter || se.adapter)(e).then((function(t) {
                return Se(e),
        ...
        function Te(e, t) {
            ...
            const n = {};
            function r(e, t, n) {
                return L.isPlainObject(e) && L.isPlainObject(t) ? L.merge.call({
                    caseless: n
                }, e, t) : L.isPlainObject(t) ? L.merge({}, t) : L.isArray(t) ? t.slice() : t
            }
            function o(e, t, n) {
            ...
            return L.forEach(Object.keys(Object.assign({}, e, t)), (function(r) {
                const s = c[r] || o
                  , i = s(e[r], t[r], r);
                ...
                for (; o-- > 0; ) {
                    ...
                    if (i) {
                        const t = e[s]
                          , n = void 0 === t || i(t, s, e);
                        if (!0 !== n)
                            throw new z("option " + s + " must be " + n,z.ERR_BAD_OPTION_VALUE)
                    } else if (!0 !== n)
        ...
        class je {
            ...
            request(e, t) {
                ...
                null != r && (L.isFunction(r) ? t.paramsSerializer = {
                    serialize: r
                } : Ne.assertOptions(r, {
                    encode: xe.function,
                ...
                s && L.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (e => {
                    delete o[e]
                }
                )),
        ...
        const De = function e(t) {
            ...
            return L.extend(o, Pe.prototype, n, {
                allOwnKeys: !0
            }),
            L.extend(o, n, null, {
                allOwnKeys: !0
        ...
        De.default = De;
        var Le = De;
        const {Axios: ke, AxiosError: Ie, CanceledError: qe, isCancel: ze, CancelToken: Me, VERSION: He, all: Je, Cancel: Ve, isAxiosError: We, spread: Ke, toFormData: Ge, AxiosHeaders: $e, HttpStatusCode: Xe, formToJSON: Qe, mergeConfig: Ze} = Le
    }
}]);
