(self.webpackChunkfederation_clients = self.webpackChunkfederation_clients || []).push([["node_modules_webfontloader_webfontloader_js"], {
    "./node_modules/webfontloader/webfontloader.js": (t, n, i) => {
        var e;
        !function() {
            function o(t, n, i) {
            ...
            function B(t, n, i, e, o, a, s) {
                ...
                t = P(t = new j(this.a.c + ",serif",k(this.a))),
                this.g.a.style.cssText = t,
                t = P(t = new j(this.a.c + ",sans-serif",k(this.a))),
                this.h.a.style.cssText = t,
                t = P(t = new j("serif",k(this.a))),
                this.j.a.style.cssText = t,
                t = P(t = new j("sans-serif",k(this.a))),
                    ...
                    if (0 === i.length && a)
                        ...
                        for (c = 0; c < i.length; c++) {
                            var h = i[c]
                              ...
                              , u = n.a
                              , d = h;
                            if (u.g && p(u.f, [u.a.c("wf", d.c, k(d).toString(), "loading")]),
                            N(u, "fontloading", d),
                            u = null,
                            null === z)
                                if (window.FontFace) {
                                    ...
                                    z = d ? 42 < parseInt(d[1], 10) : !g
                                } else
                                    z = !1;
                            u = z ? new W(s(n.g, n),s(n.h, n),n.c,h,n.s,l) : new B(s(n.g, n),s(n.h, n),n.c,h,n.s,t,l),
                            f.push(u)
                        }
                    ...
                    if (a["__mti_fntLst" + e]) {
                        ...
                        if (o)
                            for (var r = 0; r < o.length; r++) {
                                ...
                                null != o[r].fontStyle && null != o[r].fontWeight ? (i = o[r].fontStyle + o[r].fontWeight,
                                s.push(new j(c,i))) : s.push(new j(c))
                            }
                        t(s)
                    } else
                        setTimeout((function() {
            ...
            V.prototype.load = function(t) {
                var n, i, e = this.a.urls || [], o = this.a.families || [], a = this.a.testStrings || {}, s = new w;
                for (n = 0,
                i = e.length; n < i; n++)
                    g(this.c, e[n], m(s));
                var r = [];
